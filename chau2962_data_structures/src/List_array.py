...
class List:
    ...
    def _linear_search(self, key):
        ...
        while not found and i_local < stop:
            if self._values[i_local] == key:
                found = True
                i = i_local
            i_local += 1
        return i
    ...
    def combine(self, source1, source2):
        ...
        while i1 < l1 or i2 < l2:
            if i1 < l1:
                self.append(source1._values[i1])
                i1 += 1
            if i2 < l2:
                self.append(source2._values[i2])
                i2 += 1
        return None
    ...
    def insert(self, i, value):
        ...
        -------------------------------------------------------
        """
        clamped = clamp(i, -len(self._values), len(self._values))
        self._values.insert(clamped, deepcopy(value))
        return None
    ...
    def max(self):
        ...
        for v in self._values:
            if v > value:
                value = v
        value = deepcopy(value)  # only copy when we're sure we found our value
        return value
    ...
    def remove(self, key):
        ...
        """
        value = None
        first_idx = self._linear_search(key)
        if first_idx >= 0:
            value = self._values.pop(first_idx)
        return value
