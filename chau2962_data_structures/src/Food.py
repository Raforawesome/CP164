...
class Food:
    ...
    def origins():
        ...
        """
        string = ""
        # for (i, c) in enumerate(Food.ORIGIN):
        #     string += f"{i} {c}\n"
        # ^ rejected by grader :?
    ...
    def __str__(self):
        ...
        """
        string = ""
        string += f"{'Name:':<13}{self.name}\n"
        string += f"{'Origin:':<13}{self.origin}\n"
        string += f"{'Vegetarian:':<13}{self.is_vegetarian}\n"
        string += f"{'Calories:':<13}{self.calories}\n"
        return string
